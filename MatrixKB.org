...
***** [[https://matrix.to/#/@MTRNord:matrix.ffslfl.net][MTRNord]] is currently working on adding the necessary i18n infrastructure:
:PROPERTIES:
...
#+BEGIN_QUOTE
for those interested in riot-web translations: there is a channel. (backlog is german but english is no problem there)
#riotweb-translations:matrix.org
#+END_QUOTE
